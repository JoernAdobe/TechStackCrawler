    ...
    <header className="w-full backdrop-blur-sm bg-ts-surface/80 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="group w-8 h-8 rounded-lg bg-gradient-to-br from-adobe-red to-red-700 flex items-center justify-center transition-shadow duration-300 hover:shadow-glow-red cursor-default">
            <svg
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-ts-border bg-ts-surface-light hover:bg-ts-surface-card transition-all duration-200 text-ts-text-secondary hover:text-ts-text-primary hover:border-ts-accent/30"
          >
            {soundEnabled ? (
              <>
      ...
      <div className="h-px w-full bg-gradient-to-r from-transparent via-ts-accent/50 to-transparent animate-shimmer" style={{ backgroundSize: '200% 100%' }} />
    </header>
  );
}
